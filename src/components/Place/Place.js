...
export const Place = ({ train, wagon, place }) => {
  ...
  //                   console.log(" Error Fill the Field ")
  //                   return
  //               }
  //               if (!name) {
  ...
  //               }
  //               if (!surname) {
  //                   console.log("Error Enter a surname");
  //                   return ;
  //               }
  //               if (!cardNumber) {
  //                   console.log("Error Enter a card number");
  //                   return
  //               }
    ...
    <div>
      <Modal open={open} onClose={() => setOpen(false)}>
        <div style={modalStyle} className={classes.paper}>
          ...
          <Button
            className="place__firstModalButton"
      ...
      <Modal open={openBuy} onClose={() => setOpenBuy(false)}>
        <div style={modalStyle} className={classes.paper}>
          <form>
            <center>
              <img
            ...
            <FormControl className="place__BuyingForm">
              ...
              />
              <NavLink className="place__buttonContainer" to="/railwaySearch">
                <Button
                  onClick={buy}
      ...
      {/*  </div>*/}
      {/*</Modal>*/}
      <div className="place__title">{wagon} wagon</div>
      <div className="place__container">
        {place.Places.map((item) => (
          <div
            className="place"
            onClick={() => {
              setChoosenPlace(item.PlaceNumber);
              setOpen(true);
            }}
          >
            {item.PlaceNumber}
